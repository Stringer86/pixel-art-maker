...
// paletteSection.appendChild(rowButton);
// eSquare.className = 'rowButton';
// eSquare.textContent = 'Add Row!';
// rowButton.addEventListener('click', createRow);

// var columnButton = document.createElement('button');
// paletteSection.appendChild(columnButton);
// eSquare.className = 'columnButton';
// eSquare.textContent = 'Add Column!';
// columnButton.addEventListener('click', createBoard);
